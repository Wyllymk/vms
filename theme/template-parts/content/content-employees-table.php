            ...
            <thead>
                <tr class="border-b border-gray-100 dark:border-gray-800">
                    ...
                    <th class="px-5 py-3 sm:px-6">
                        <div class="flex items-center">
                            <p class="font-medium text-gray-500 text-theme-xs dark:text-gray-400">
                                <?php esc_html_e( 'Status', 'cyber-wakili' ); ?>
                            </p>
                        </div>
                    </th>
                    <th class="px-5 py-3 sm:px-6">
            ...
            <tbody class="divide-y divide-gray-100 dark:divide-gray-800">
                <?php
                    ...
                    if (isset($_GET['search_users']) && !empty($_GET['user_search'])) {
                        ...
                        $args = array(
                            'role__in' => array('advocate', 'pupil', 'managing_partner', 'senior_partner'),
                ...
                <?php
                        ...
                        $users = get_users(array('role__in' => array('advocate','administrator', 'pupil', 'managing_partner', 'senior_partner')));
