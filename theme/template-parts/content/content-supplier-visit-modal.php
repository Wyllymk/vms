...
<div x-show="isSupplierVisitInfoModal"
    ...
    <div @click.outside="isSupplierVisitInfoModal = false"
        ...
        <form id="supplier-visit-form" class="flex flex-col" method="post" enctype="multipart/form-data">
            ...
            <div class="flex items-center gap-3 px-2 mt-6 lg:justify-end">
                <button @click="isSupplierVisitInfoModal = false" type="button"
