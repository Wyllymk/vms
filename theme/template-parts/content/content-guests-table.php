        ...
        <table class="min-w-full">
            ...
            <tbody class="divide-y divide-gray-100 dark:divide-gray-800">
                ...
                <tr>
                    ...
                    <td class="px-5 py-4 sm:px-6">
                        <form action="<?php echo esc_url(site_url('/guest-details')); ?>" method="get">
                ...
                <?php
                            ...
                            echo '<tr><td colspan="10" class="px-4 py-4 text-center text-white">No guests found.</td></tr>';
                        }
                    } else {
                        // Display all users if no search
                        $users = get_users(array('role__in' => array('guest')));
                        if (!empty($users)) {
                            foreach ($users as $user) {
                                // Same as above
                                $user_id = $user->ID;
                ...
                <?php
                        ...
                        echo '<tr><td colspan="10" class="px-4 py-4 text-center text-gray-600 dark:text-white">No guests found.</td></tr>';
                    }
                }
                ?>
            </tbody>
