...
<div x-show="isAccommodationInfoModal"
	class="fixed inset-0 flex items-center justify-center p-5 overflow-y-auto z-99999">
	<div class="modal-close-btn fixed inset-0 h-full w-full bg-gray-400/50 backdrop-blur-[32px]"></div>
	<div @click.outside="isAccommodationInfoModal = false"
		class="no-scrollbar relative w-full max-w-[700px] overflow-y-auto rounded-3xl bg-white p-4 dark:bg-gray-900 lg:p-11">
		<!-- close btn -->
		<a @click="isAccommodationInfoModal = false"
		...
		<form id="accommodation-guest-form" class="flex flex-col" method="post" enctype="multipart/form-data">
			...
			<div class="flex items-center gap-3 px-2 mt-6 lg:justify-end">
				<button @click="isAccommodationInfoModal = false"
				...
				<button type="submit" id="submit-accommodation-guest-form"
