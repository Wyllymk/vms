...
<header x-data="{menuToggle: false}"
    ...
    <div class="flex flex-col items-center justify-between grow lg:flex-row lg:px-6">
        <div
            ...
            <a :class="sidebarToggle ? 'lg:bg-transparent dark:lg:bg-transparent bg-gray-100 dark:bg-gray-800' : ''"
                class="flex items-center justify-center w-10 h-10 text-gray-500 border-gray-200 rounded-lg cursor-pointer z-99999 lg:h-11 lg:w-11 lg:border dark:border-gray-800 dark:text-gray-400"
            ...
            <a href="<?php echo esc_url(home_url());?>" class="lg:hidden">
                <img class="h-10" src="<?php echo get_template_directory_uri(); ?>/assets/images/logo/logo.png"
                    alt="Logo" />
            </a>

            <!-- Application nav menu button -->
            <a class="flex items-center justify-center w-10 h-10 text-gray-700 rounded-lg z-99999 hover:bg-gray-100 lg:hidden dark:text-gray-400 dark:hover:bg-gray-800"
            ...
            <div class="hidden lg:block">
                <form>
                    <div class="relative">
                        ...
                        <a id="search-button"
                            class="cursor-pointer absolute top-1/2 right-2.5 inline-flex -translate-y-1/2 items-center gap-0.5 rounded-lg border border-gray-200 bg-gray-50 px-[7px] py-[4.5px] text-xs -tracking-[0.2px] text-gray-500 dark:border-gray-800 dark:bg-white/[0.03] dark:text-gray-400">
                            <span> ⌘ </span>
                            <span> K </span>
                        </a>
                    </div>
                ...
                <div class="relative" x-data="{ dropdownOpen: false, notifying: true }"
                    ...
                    <div x-show="dropdownOpen"
                        ...
                        <div
                            ...
                            <a @click="dropdownOpen = false" class="text-gray-500 dark:text-gray-400">
                                <svg class="fill-current" width="24" height="24" viewBox="0 0 24 24" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path fill-rule="evenodd" clip-rule="evenodd"
                                        d="M6.21967 7.28131C5.92678 6.98841 5.92678 6.51354 6.21967 6.22065C6.51256 5.92775 6.98744 5.92775 7.28033 6.22065L11.999 10.9393L16.7176 6.22078C17.0105 5.92789 17.4854 5.92788 17.7782 6.22078C18.0711 6.51367 18.0711 6.98855 17.7782 7.28144L13.0597 12L17.7782 16.7186C18.0711 17.0115 18.0711 17.4863 17.7782 17.7792C17.4854 18.0721 17.0105 18.0721 16.7176 17.7792L11.999 13.0607L7.28033 17.7794C6.98744 18.0722 6.51256 18.0722 6.21967 17.7794C5.92678 17.4865 5.92678 17.0116 6.21967 16.7187L10.9384 12L6.21967 7.28131Z"
                        ...
                        <ul class="flex flex-col h-auto overflow-y-auto custom-scrollbar">
                            <li>
                                <a class="flex gap-3 rounded-lg border-b border-gray-100 p-3 px-4.5 py-3 hover:bg-gray-100 dark:border-gray-800 dark:hover:bg-white/5"
                                    ...
                                    <span class="relative block w-full h-10 rounded-full z-1 max-w-10">
                                        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/user/user-02.jpg"
                            ...
                            <li>
                                <a class="flex gap-3 rounded-lg border-b border-gray-100 p-3 px-4.5 py-3 hover:bg-gray-100 dark:border-gray-800 dark:hover:bg-white/5"
                                    href="#">
                                    <span class="relative block w-full h-10 rounded-full z-1 max-w-10">
                                        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/user/user-03.jpg"
                                            alt="User" class="overflow-hidden rounded-full" />
                                        <span
                                            class="bg-success-500 absolute right-0 bottom-0 z-10 h-2.5 w-full max-w-2.5 rounded-full border-[1.5px] border-white dark:border-gray-900"></span>
                                    </span>
                            ...
                            <li>
                                <a class="flex gap-3 rounded-lg border-b border-gray-100 p-3 px-4.5 py-3 hover:bg-gray-100 dark:border-gray-800 dark:hover:bg-white/5"
                                    href="#">
                                    <span class="relative block w-full h-10 rounded-full z-1 max-w-10">
                                        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/user/user-04.jpg"
                                            alt="User" class="overflow-hidden rounded-full" />
                                        <span
                                            class="bg-success-500 absolute right-0 bottom-0 z-10 h-2.5 w-full max-w-2.5 rounded-full border-[1.5px] border-white dark:border-gray-900"></span>
                                    </span>
                            ...
                            <li>
                                <a class="flex gap-3 rounded-lg border-b border-gray-100 p-3 px-4.5 py-3 hover:bg-gray-100 dark:border-gray-800 dark:hover:bg-white/5"
                                    href="#">
                                    <span class="relative block w-full h-10 rounded-full z-1 max-w-10">
                                        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/user/user-05.jpg"
                                            alt="User" class="overflow-hidden rounded-full" />
                                        <span
            ...
            <div class="relative" x-data="{ dropdownOpen: false }" @click.outside="dropdownOpen = false">
                <a class="flex items-center text-gray-700 dark:text-gray-400" href="#"
                    ...
                    <span class="mr-3 overflow-hidden rounded-full h-11 w-11">
                        ...
                        <img class="object-cover w-10 h-10 border-2 border-gray-200 rounded-full dark:border-gray-700"
                            src="<?php echo esc_url( get_user_meta( $user_id, 'profile_picture', true ) ?: $user_avatar ); ?>"
                            alt="Profile Picture">
                    </span>
                    ...
                    <ul class="flex flex-col gap-1 pt-4 pb-3 border-b border-gray-200 dark:border-gray-800">
                        <li>
                            <a href="<?php echo esc_url( home_url( '/profile' ) ); ?>"
                                ...
                                <?php esc_html_e( 'Edit profile', 'vms' ); ?>
                            </a>
                        </li>
                    </ul>
