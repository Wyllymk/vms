...
<div class="rounded-2xl border border-gray-200 bg-gray-100 dark:border-gray-800 dark:bg-white/[0.03]">
    <div class="px-5 pt-5 bg-white shadow-default rounded-2xl pb-11 dark:bg-gray-900 sm:px-6 sm:pt-6">
        <div class="flex justify-between">
            <div>
                ...
                <p class="mt-1 text-gray-500 text-theme-sm dark:text-gray-400">
                    Track visitor activity and performance goals
                </p>
            </div>
        ...
        <div class="relative max-h-[195px]">
            ...
            <span
                class="absolute left-1/2 top-[85%] -translate-x-1/2 -translate-y-[85%] rounded-full bg-success-50 px-3 py-1 text-xs font-medium text-success-600 dark:bg-success-500/15 dark:text-success-500">+15%</span>
        </div>
        <p class="mx-auto mt-1.5 w-full max-w-[380px] text-center text-sm text-gray-500 sm:text-base">
            You’ve logged 320 visits this month, exceeding your target. Great performance!
        </p>
    </div>
