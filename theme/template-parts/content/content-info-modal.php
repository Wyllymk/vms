    ...
    <div @click.outside="isProfileInfoModal = false"
        ...
        <div class="px-2 pr-14">
            <h4 class="mb-2 text-2xl font-semibold text-gray-800 dark:text-white/90">
                <?php esc_html_e( 'Edit Personal Information', 'cyber-wakili' ); ?>
            </h4>
            <p class="mb-6 text-sm text-gray-500 dark:text-gray-400 lg:mb-7">
                <?php esc_html_e( 'Update your details to keep your profile up-to-date.', 'cyber-wakili' ); ?>
            </p>
        </div>
        <form id="your-profile-form" class="flex flex-col" method="post" enctype="multipart/form-data">
            ...
            <div class="flex items-center gap-3 px-2 mt-6 lg:justify-end">
                <button @click="isProfileInfoModal = false" type="button"
                    ...
                    <?php esc_html_e( 'Close', 'cyber-wakili' ); ?>
                    </a>
                    <button type="submit" id="submit-button"
                        ...
                        <?php esc_html_e( 'Save Changes', 'cyber-wakili' ); ?>
                    </button>
            </div>
        </form>
    </div>
