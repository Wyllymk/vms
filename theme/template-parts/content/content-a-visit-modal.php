...
<div x-show="isAVisitInfoModal" class="fixed inset-0 flex items-center justify-center p-5 overflow-y-auto z-99999">
	<div class="modal-close-btn fixed inset-0 h-full w-full bg-gray-400/50 backdrop-blur-[32px]"></div>
	<div @click.outside="isAVisitInfoModal = false"
		class="no-scrollbar relative w-full max-w-lg overflow-y-auto rounded-3xl bg-white p-4 dark:bg-gray-900 lg:p-11">
		<!-- close btn -->
		<a @click="isAVisitInfoModal = false"
		...
		<div class="px-2 pr-14">
			<h4 class="mb-2 text-2xl font-semibold text-gray-800 dark:text-white/90">
				<?php esc_html_e( 'Register Visit', 'vms' ); ?>
			</h4>
		...
		<form id="accommodation-visit-form" class="flex flex-col" method="post" enctype="multipart/form-data">
			...
			<div class="flex items-center gap-3 px-2 mt-6 lg:justify-end">
				<button @click="isAVisitInfoModal = false" type="button"
				...
				<button type="submit" id="submit-visit-form"
					...
					<?php esc_html_e( 'Create Visit', 'vms' ); ?>
				</button>
			</div>
		</form>
	</div>
