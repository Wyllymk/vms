                ...
                <div class="">
                    ...
                    <div class="grid grid-cols-1 gap-x-6 gap-y-5 lg:grid-cols-2">
                        ...
                        <div class="col-span-2 lg:col-span-1">
							...
							$is_locked = in_array( 'member', $user_roles, true ) || in_array( 'chairman', $user_roles, true ) || in_array( 'general_manager', $user_roles, true );

							// Get all active members and chairmen
							$members = get_users(
								array(
									'role__in'   => array( 'member', 'chairman', 'general_manager' ),
