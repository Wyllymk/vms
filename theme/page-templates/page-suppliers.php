<?php
/**
 * The template for displaying the suppliers page
 *
...
<section x-data="{ page: 'suppliers',  'isSupplierInfoModal': false}"
    @close-supplier-modal.window="isSupplierInfoModal = false">
    <!-- ===== Page Wrapper Start ===== -->
                        ...
                        <div
                            ...
                            <div class="px-5 py-4 sm:px-6 sm:py-5">
                                <h3 class="text-base font-medium text-gray-800 dark:text-white/90">
                                    <?php esc_html_e( 'Suppliers Visits', 'vms' ); ?>
                                </h3>
                            </div>
                            <div class="flex flex-wrap justify-between w-full px-5 mb-4 sm:px-6 ">
                                ...
                                <div class="flex items-center w-full mb-4 md:w-1/2 md:mb-0">
                                    <div class="relative">
                                        ...
                                        <input type="text" placeholder="Filter suppliers by name..."
                                            id="search-suppliers-input" x-data="{ searchValue: '' }"
                                            x-model="searchValue"
                                            @input.debounce.300ms="$dispatch('search-suppliers-updated', $event.target.value)"
                                        ...
                                        <button type="button" @click="$dispatch('clear-suppliers-search')"
                                ...
                                <div
                                    ...
                                    <a @click="isSupplierInfoModal = true"
    ...
    <!-- BEGIN MODAL -->
    <?php get_template_part( 'template-parts/content/content', 'supplier-modal' ); ?>
    <!-- END MODAL -->
</section>
