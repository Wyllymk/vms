                            ...
                            <div class="flex flex-wrap justify-between w-full px-5 mb-4 sm:px-6 ">
                                ...
                                <div class="flex items-center w-full mb-4 md:w-1/2 md:mb-0">
                                    <div class="relative">
                                        ...
                                        <input type="text" placeholder="Filter accommodation guests by name..."
                                            id="search-accommodation-guests-input" x-data="{ searchValue: '' }"
                                            x-model="searchValue"
                                            @input.debounce.300ms="$dispatch('search-accommodation-guests-updated', $event.target.value)"
                                        ...
                                        <button type="button" @click="$dispatch('clear-accommodation-guests-search')"
