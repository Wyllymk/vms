 ...
 *
 * This is the template that displays registration page by default. Please note that
...
if ( isset( $_POST['signup'] ) ) {
	...
	if ( empty( $errors ) ) {
		...
		$user_number = sanitize_text_field( $_POST['pnumber'] );
		...
		$data = array(
			...
			'role'       => 'advocate', // give role of advocate
			'meta_input' => array(
...
?>
<section class="register-content" x-data="{ page: 'register-lawyer'">
    <!-- ===== Page Wrapper Start ===== -->
            ...
            <div class="flex flex-col flex-1 w-full lg:w-1/2">
                ...
                <div class="flex flex-col justify-center flex-1 w-full max-w-md mx-auto">
                    ...
                    <div class="flex items-center justify-between p-4 mb-4 text-red-700 bg-red-100 border-l-4 border-red-500"
                        ...
                        <button type="button" class="float-right text-red-700 hover:text-red-900"
                    ...
                    <div class="mb-5 sm:mb-8">
                        <h1 class="mb-2 font-semibold text-gray-800 text-title-sm dark:text-white/90 sm:text-title-md">
                            <?php esc_html_e( 'Sign Up', 'cyber-wakili' ); ?>
                        </h1>
                        <p class="text-sm text-gray-500 dark:text-gray-400">
                            <?php esc_html_e( 'Enter your email and password to sign up!', 'cyber-wakili' ); ?>
                        </p>
                    </div>
                    <div>
                        <div class="grid grid-cols-1 gap-3 sm:grid-cols-1">
                            <a href="<?php echo esc_url(\WyllyMk\CyberWakili\CW_Google::get_instance()->get_google_auth_url()); ?>"
                                ...
                                <?php esc_html_e( 'Sign in with Google', 'cyber-wakili' ); ?>
                            </a>
                        </div>
                        <div class="relative py-3 sm:py-5">
                            ...
                            <div class="relative flex justify-center text-sm">
                                <span class="p-2 text-gray-400 bg-white dark:bg-gray-900 sm:px-5 sm:py-2">
                                    <?php esc_html_e( 'Or', 'cyber-wakili' ); ?>
                                </span>
                            </div>
                        </div>
                            ...
                            <div class="space-y-5">
                                <div class="grid grid-cols-1 gap-5 sm:grid-cols-2">
                                    ...
                                    <div class="sm:col-span-1">
                                        ...
                                        <input name="first_name" type="text" id="fname"
                                ...
                                <div class="grid grid-cols-1 gap-5 sm:grid-cols-2">
                                    ...
                                    <div>
                                        ...
                                        <input name="pnumber" type="number" placeholder="Phone Number" id="pnumber"
                                ...
                                <div>
                                    <label class="mb-1.5 block text-sm font-medium text-gray-700 dark:text-gray-400">
                                        <?php esc_html_e( 'Password', 'cyber-wakili' ); ?>
                                        <span class="text-error-500">*</span>
                                    </label>
                                ...
                                <div>
                                    <div x-data="{ checkboxToggle: false }">
                                        <label for="checkboxLabelOne"
                                            ...
                                            <div class="relative">
                                                <input name="remember_me" type="checkbox" id="checkboxLabelOne"
                                            ...
                                            <p class="inline-block font-normal text-gray-500 dark:text-gray-400">
                                                <?php esc_html_e( 'By creating an account means you agree to the', 'cyber-wakili' ); ?>
                                                <span class="text-gray-800 dark:text-white/90">
                                                    <?php esc_html_e( 'Terms and Conditions,', 'cyber-wakili' ); ?>
                                                </span>
                                                <?php esc_html_e( 'and our', 'cyber-wakili' ); ?>
                                                <span class="text-gray-800 dark:text-white">
                                                    <?php esc_html_e( 'Privacy Policy', 'cyber-wakili' ); ?>
                                                </span>
                                            </p>
                                        </label>
                                    </div>
                ...
                <div class="flex items-center justify-center z-1">
                    ...
                    <div class="flex flex-col items-center max-w-xs">
                        ...
                        <p class="text-center text-gray-400 dark:text-white/60">
                            <?php esc_html_e( 'Your Trusted Partner in Legal Technology', 'cyber-wakili' ); ?>
                        </p>
                    </div>
                </div>
            </div>
