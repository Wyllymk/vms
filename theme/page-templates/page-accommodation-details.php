...
// Handle a guest export
if ( isset( $_POST['export_a_guest'] ) && isset( $_POST['guest_id'] ) ) {
	...
	$export_type     = sanitize_text_field( $_POST['export_a_guest'] );
	...
	if ( $export_type === 'pdf' ) {
		VMS_Export_Handler::export_a_guest_pdf( $export_guest_id );
	}
			...
			<div class="relative flex flex-col flex-1 overflow-x-hidden overflow-y-auto">
				...
				<main>
					...
					<div class="p-4 mx-auto max-w-(--breakpoint-2xl) min-h-screen md:p-6">
						...
						<div
							...
							<div class="flex items-center gap-2">
								...
								<span class="text-sm font-medium text-gray-700 dark:text-gray-400">
									Export Accommodation Guest Details
								</span>
							</div>
							...
							<div class="flex flex-wrap gap-2">
								...
								<form method="post" action="" class="inline-block">
									<input type="hidden" name="export_a_guest" value="pdf">
						...
						<!-- Accommodation Guest Details Section -->
