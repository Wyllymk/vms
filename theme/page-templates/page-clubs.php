<?php
/**
 * The template for displaying the Clubs page
 *
...
if ( ! ( current_user_can( 'administrator' ) || current_user_can( 'general_manager' ) || current_user_can( 'chairman' ) || current_user_can( 'reception' ) ) ) {
...
<section x-data="{ page: 'clubs', isClubModal: false, isClubEditModal: false }"
                    ...
                    <div class="space-y-5 sm:space-y-6">
                        <div
                            ...
                            <div class="flex flex-wrap justify-between w-full px-5 mb-4 sm:px-6 ">
                                ...
                                <div class="flex items-center w-full mb-4 md:w-1/2 md:mb-0">
                                    <div class="relative">
                                        ...
                                        <input type="text" placeholder="Filter clubs by name..." id="search-clubs-input"
                                            x-data="{ searchValue: '' }" x-model="searchValue"
                                            @input.debounce.300ms="$dispatch('search-clubs-updated', $event.target.value)"
                                        ...
                                        <button type="button" @click="$dispatch('clear-clubs-search')"
                                ...
                                <!-- Register Button -->
                                <div class="flex items-center justify-end w-full md:w-1/2 gap-2 md:gap-4">
                                    <a @click="isClubModal = true"
                                        ...
                                        <?php esc_html_e( 'Register Club', 'vms' ); ?>
                                    </a>
                                </div>
                            </div>
                            ...
                            <div class="p-1 border-t border-gray-100 dark:border-gray-800 sm:p-6">
                                <!-- ====== Table Six Start -->
                                <?php get_template_part( 'template-parts/content/content', 'clubs-table' ); ?>
                                <!-- ====== Table Six End -->
                            </div>
                        </div>
                    </div>
    ...
    <!-- BEGIN MODAL -->
    <?php get_template_part( 'template-parts/content/content', 'club-modal' ); ?>
    <!-- END MODAL -->
    <!-- BEGIN MODAL -->
    <?php get_template_part( 'template-parts/content/content', 'club-edit-modal' ); ?>
    <!-- END MODAL -->
</section>
