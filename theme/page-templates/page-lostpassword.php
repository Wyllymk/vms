<?php
/**
 * The template for displaying lost password page
 *
 * This is the template that displays lost password page by default. Please note that
...
<section class="login-content" x-data="{ page: 'lost-password'}">
	<!-- ===== Page Wrapper Start ===== -->
	<div class="relative p-6 bg-white z-1 dark:bg-gray-900 sm:p-0">
		<div class="relative flex flex-col justify-center w-full h-svh dark:bg-gray-900 sm:p-0 lg:flex-row">
			<!-- Form -->
			<div class="flex flex-col flex-1 w-full lg:w-1/2">
				...
				<div class="w-full max-w-md mx-auto flex items-center justify-between p-4 mb-4 text-green-700 bg-green-100 border-l-4 border-green-500"
					role="alert">
					<div>
				...
				if ( isset( $errors_messages ) ) :
					foreach ( $errors_messages as $error_message ) :
						?>
				<div class="w-full max-w-md mx-auto flex items-center justify-between p-4 mb-4 text-white bg-red-500 border-l-4 border-red-700 rounded"
					role="alert">
					<div>
						<strong>Warning!</strong>
						<p class="text-sm">
						<?php echo ucwords( esc_html( $error_message ) ); ?></p>
					</div>
