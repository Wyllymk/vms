...
<section id="primary" x-data="{ page: 'details', 'isGuestVisitInfoModal': false}"
    ...
    <main id="main">
        ...
        <div class="flex h-svh overflow-hidden">
            ...
            <div class="relative flex flex-col flex-1 overflow-x-hidden overflow-y-auto">
                                        ...
                                        <div
                                            ...
                                            <div class="flex items-center justify-between px-5 py-4 sm:px-6 sm:py-5">
                                                ...
                                                <div class="flex items-center justify-end w-full md:w-1/2">
                                                    <a <?php
													if ( $is_active ) :
														?> @click="isGuestVisitInfoModal = true" <?php endif; ?>
                ...
                <!-- BEGIN MODAL -->
                <?php get_template_part( 'template-parts/content/content', 'guest-visit-modal' ); ?>
                <!-- END MODAL -->
