...
<section class="login-content" x-data="{ page: 'password-reset'}">
    <!-- ===== Page Wrapper Start ===== -->
    <div class="relative p-6 bg-white z-1 dark:bg-gray-900 sm:p-0">
        <div class="relative flex flex-col justify-center w-full h-screen dark:bg-gray-900 sm:p-0 lg:flex-row">
            ...
            <div class="flex flex-col flex-1 w-full lg:w-1/2">
                ...
                <div class="max-w-lg mx-auto p-4 mb-4 text-white bg-red-500 rounded"><?php echo esc_html( $error ); ?>
                </div>
                <?php endforeach; ?>
                <?php elseif ( $success ) : ?>
                <div class="max-w-lg mx-auto p-4 mb-4 text-white bg-green-500 rounded">
                    <?php echo wp_kses_post( $success ); ?></div>
                <?php endif; ?>
                    ...
                    <div>
                        <div class="mb-5 sm:mb-8">
                            ...
                            <p class="text-sm text-gray-500 dark:text-gray-400">
                                <?php esc_html_e( "Enter your new password.", 'vms' ); ?>
                            </p>
                        </div>
                        <div>
                                ...
                                <div class="space-y-5">
                                    ...
                                    <div>
                                        <button type="submit" name="reset_password"
                                            class="w-full px-6 py-3 text-white bg-brand-500 rounded-md hover:bg-brand-600 focus:outline-none focus:ring-2 focus:ring-brand-400 focus:ring-opacity-50">
