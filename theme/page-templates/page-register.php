...
if ( isset( $_POST['signup'] ) ) {
	...
	if ( empty( $errors ) ) {
		...
		// Ensure it's a valid login and unique
...
<section class="register-content" x-data="{ page: 'register' }">
	...
	<div class="relative p-6 bg-white z-1 dark:bg-gray-900 sm:p-0">
		<div class="flex flex-col justify-center w-full h-screen sm:p-0 lg:flex-row dark:bg-gray-900">
			<!-- Form -->
				...
				<div class="flex flex-col justify-center flex-1 w-full max-w-md mx-auto">
					...
					<div class="mb-5 sm:mb-8">
						...
						<p class="text-sm text-gray-500 dark:text-gray-400">
							<?php esc_html_e( 'Enter your details to sign up!', 'vms' ); ?>
						</p>
					</div>
					<div>
							...
							<div class="space-y-5">
								...
								<div class="grid grid-cols-1 gap-5 sm:grid-cols-2">
									...
									<div>
										...
										<input name="user_number" type="text" placeholder="Phone Number"
											id="user_number" class="dark:bg-dark-900 h-11 w-full rounded-lg border border-gray-300
									...
									<div>
										...
										<input name="member_number" type="text" placeholder="Member Number"
											id="member_number" class="dark:bg-dark-900 h-11 w-full rounded-lg border border-gray-300
										bg-transparent px-4 py-2.5 text-sm text-gray-800 shadow-theme-xs
										placeholder:text-gray-400 focus:border-brand-300 focus:outline-hidden
										focus:ring-3 focus:ring-brand-500/10 dark:border-gray-700 dark:bg-gray-900
										dark:text-white/90 dark:placeholder:text-white/30 dark:focus:border-brand-800"
									...
									<div x-data="{ checkboxToggle: false }">
										<label for="checkboxLabelOne"
											...
											<p class="inline-block font-normal text-gray-500 dark:text-gray-400">
												<?php esc_html_e( 'By creating an account means you agree to the', 'vms' ); ?>
												<span class="text-gray-800 dark:text-white/90">
													<?php esc_html_e( 'Terms and Conditions,', 'vms' ); ?>
												</span>
												<?php esc_html_e( 'and our', 'vms' ); ?>
												<span class="text-gray-800 dark:text-white">
													<?php esc_html_e( 'Privacy Policy', 'vms' ); ?>
												</span>
											</p>
										</label>
									</div>
