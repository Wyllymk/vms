                                ...
                                <div class="flex w-full items-center md:w-1/2 mb-4 md:mb-0">
                                    <div class="relative">
                                        ...
                                        <input type="text" placeholder="Filter members by name..."
                                            id="search-users-input" x-data="{ searchValue: '' }" x-model="searchValue"
                                            @input.debounce.300ms="$dispatch('search-users-updated', $event.target.value)"
                                        ...
                                        <button type="button" @click="$dispatch('clear-users-search')"
