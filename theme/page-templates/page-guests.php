                        ...
                        <div
                            ...
                            <div class="px-5 py-4 sm:px-6 sm:py-5">
                                <h3 class="text-base font-medium text-gray-800 dark:text-white/90">
                                    <?php esc_html_e( 'Guests Visits', 'vms' ); ?>
                                </h3>
                            </div>
                            <div class="flex flex-wrap justify-between w-full px-5 mb-4 sm:px-6 ">
                                ...
                                <div class="flex items-center w-full mb-4 md:w-1/2 md:mb-0">
                                    <div class="relative">
                                        ...
                                        <input type="text" placeholder="Filter guests by name..."
                                            id="search-guests-input" x-data="{ searchValue: '' }" x-model="searchValue"
                                            @input.debounce.300ms="$dispatch('search-guests-updated', $event.target.value)"
                                        ...
                                        <button type="button" @click="$dispatch('clear-guests-search')"
